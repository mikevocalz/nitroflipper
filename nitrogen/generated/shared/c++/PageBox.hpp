...
namespace margelo::nitro::nitroflipper {
  ...
  /**
   * A struct which can be represented as a JavaScript object (PageBox).
   */
  struct PageBox final {
  public:
  ...
  public:
    PageBox() = default;
    explicit PageBox(double width, double height): width(width), height(height) {}

  public:
    friend bool operator==(const PageBox& lhs, const PageBox& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ PageBox <> JS PageBox (object)
  template <>
  struct JSIConverter<margelo::nitro::nitroflipper::PageBox> final {
    static inline margelo::nitro::nitroflipper::PageBox fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitroflipper::PageBox(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitroflipper::PageBox& arg) {
