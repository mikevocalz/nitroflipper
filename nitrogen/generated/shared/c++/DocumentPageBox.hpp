...
namespace margelo::nitro::nitroflipper {
  ...
  /**
   * A struct which can be represented as a JavaScript object (DocumentPageBox).
   */
  struct DocumentPageBox final {
  public:
    double width     SWIFT_PRIVATE;
    double height     SWIFT_PRIVATE;

  public:
    DocumentPageBox() = default;
    explicit DocumentPageBox(double width, double height): width(width), height(height) {}

  public:
    friend bool operator==(const DocumentPageBox& lhs, const DocumentPageBox& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ DocumentPageBox <> JS DocumentPageBox (object)
  template <>
  struct JSIConverter<margelo::nitro::nitroflipper::DocumentPageBox> final {
    static inline margelo::nitro::nitroflipper::DocumentPageBox fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitroflipper::DocumentPageBox(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitroflipper::DocumentPageBox& arg) {
